<?php
	$config['smtp_username'] = 'thenav@mail.ru';  //Смените на имя своего почтового ящика.
	$config['smtp_port']	 = '465'; // Порт работы. Не меняйте, если не уверены.
	$config['smtp_host']	 = 'smtp.mail.ru';  //сервер для отправки почты
	$config['smtp_password'] = 'kajmadaa';  //Измените пароль
...
smtpmail('nameaniq@gmail.com', 'Тема письма', 'Текст письма', $headers);