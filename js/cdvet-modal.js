(function(d, log, c, aEL) {
  ...
  var pages = [
    'http://parser/',
    'http://parser/a.php/',
    'https://b2b.cdvet.de/fit-crock-sensitive-lamm-10-kg-12mm',
  ];
  // проверка
  log(location.origin+location.pathname);
