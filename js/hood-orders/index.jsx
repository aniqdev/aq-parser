...
class ModalContent extends React.Component {
  ...
  render() {
   ...
   return (
<div className="op-main-modal ho-modal">
	<div className="op-modal-header">
		{this.state.modal_title}
		<div className="op-modal-tabs pull-right">
            <a href={'#info'}  className={'op-modal-tab '+is_active(this.state.route, 'info')}>Info</a>
            <a href={'#chat'}  className={'op-modal-tab '+is_active(this.state.route, 'chat')}>Chat</a>
		</div>
	</div>
	<div className="op-modal-body">
		<Child order_info={this.props.order_info}/>
  	</div>
	<div className="op-modal-footer">
		<a onClick={this.modalClose} className="op-modal-btn">close</a>
	</div>
</div>
   );
  }
