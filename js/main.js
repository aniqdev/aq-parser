...
$('.jsm-arr').click(function(e) {
  ...
  FF.js_modal_buy_button.attr('action', '?action=invoice&platiid='+FF.game_line['item'+FF.consec+'_id']);
...
GenObj.js_tch_deligator.on('click', '.tch-merged', {f:FF}, function(e) {
  ...
  F.js_modal_buy_button.attr('action', '?action=invoice&platiid='+F.tr.attr('data-plati1id'));
