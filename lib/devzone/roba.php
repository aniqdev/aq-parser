...
<head>
    ...
    <title>Roba - Chat and Discussion Platform</title>

	<base href="http://roba.laborasyon.com/demos/dark/">
    <!-- Favicon -->
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="mt-4 mb-4">
                            ...
                            <ul class="list-inline social-links">
                                ...
                                <li class="list-inline-item">
                                    <a href="#" class="btn btn-sm btn-floating btn-linkedin" data-toggle="tooltip" title="Linkedin">
                                        <i class="fa fa-linkedin"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="#" class="btn btn-sm btn-floating btn-google" data-toggle="tooltip" title="Google">
