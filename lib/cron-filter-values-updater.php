...
arrayDB('TRUNCATE filter_values');
...
{
/////////////////////////////////////////////////////////////////////////////////
	$insert_query = 'INSERT INTO filter_values (steam_table,name,value,count) VALUES '.PHP_EOL;
	// ==============================================================================
	// Сохраняем значения годов
	$years_res = [];
	foreach ($games_arr as $val) {
		if(strlen($val['year']) > 3) @$years_res[$val['year']] += 1;
	}
